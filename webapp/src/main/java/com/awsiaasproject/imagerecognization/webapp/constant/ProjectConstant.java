...
public class ProjectConstant {
	...
	public static final String AMI_ID = "ami-037c266656e02550f"; 		//Amazon Machie Image provided by professor, customize image as per your requirement.
	...
	public static final String INPUT_BUCKET = "nisarg-s3-input-bucket";

	public static final String OUTPUT_BUCKET = "nisarg-s3-output-bucket";
